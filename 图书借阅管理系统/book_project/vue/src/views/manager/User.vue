...
<!--      <el-table-column align="center" prop="password" label="密码"></el-table-column>-->
      ...
      <el-table-column label="操作" width="240" align="center">
        <template v-slot="scope">
          <el-button type="primary" @click="handleEdit(scope.row)" size="mini" v-if="user.role === 'ADMIN'">编辑</el-button>
          <el-button type="warning" @click="resetPass(scope.row)" size="mini" v-if="user.role === 'ADMIN'">重置密码</el-button>
          <el-popconfirm
              v-if="user.role === 'ADMIN'"
              style="margin-left: 10px"
